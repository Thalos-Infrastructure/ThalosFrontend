...
export const metadata: Metadata = {
  ...
  description:
    "Create secure payment agreements with protected funds and staged releases. Simple, transparent, and reliable.",
  generator: "v0.app",
        ...
        <LanguageProvider>
          <AuthProvider>
            ...
            <StellarWalletProvider>
              <PollarWalletProvider>{children}</PollarWalletProvider>
            </StellarWalletProvider>
            {/* </ThalosAcceslyProvider> */}
          </AuthProvider>
        </LanguageProvider>
