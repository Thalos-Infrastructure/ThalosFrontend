...
export const statusConfig: Partial<Record<AgreementStatus, { labelKey: string; color: string }>> & Record<string, { labelKey: string; color: string }> = {
  ...
  active: { labelKey: "status.inProgress", color: "bg-[#f0b400]/10 text-[#f0b400] border-[#f0b400]/20" },
  ...
  completed: { labelKey: "status.released", color: "bg-emerald-500/10 text-emerald-400 border-emerald-500/20" },
};
