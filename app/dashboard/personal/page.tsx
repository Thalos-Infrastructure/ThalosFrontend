...
const mockAgreements = [
  { id: "AGR-001", title: "Website Redesign", status: "funded", type: "Single Release", counterparty: "G...FRE3", amount: "2,500", date: "2026-01-15" },
  { id: "AGR-002", title: "Moving Service", status: "in_progress", type: "Single Release", counterparty: "G...MOV7", amount: "800", date: "2026-01-20" },
  { id: "AGR-003", title: "Online Course Bundle", status: "released", type: "Multi Release", counterparty: "G...EDU4", amount: "1,200", date: "2025-12-10" },
]
...
export default function PersonalDashboardPage() {
  ...
  <div className="absolute inset-0 bg-black/55" />
      ...
      {/* Header */}
      <header className="sticky top-0 z-40 border-b border-white/6 bg-[#0a0a0c]/80 backdrop-blur-xl">
      ...
      <div className="relative z-10 flex min-h-[calc(100vh-64px)]">
        {/* Sidebar */}
        <aside className={cn(
          "fixed inset-y-16 left-0 z-30 w-64 border-r border-white/6 bg-[#0a0a0c]/90 backdrop-blur-xl transition-transform duration-300 lg:sticky lg:top-16 lg:translate-x-0 lg:h-[calc(100vh-64px)]",
          ...
          <div className="mt-auto border-t border-white/6 p-4">
            <div className="rounded-xl bg-[#f0b400]/5 border border-[#f0b400]/10 p-4">
              <p className="text-[10px] font-bold uppercase tracking-widest text-[#f0b400]/60">Total Balance</p>
        ...
        <main className="flex-1 overflow-y-auto p-4 lg:p-8">
          ...
          {activeSection === "dashboard" && (
            <div className="mx-auto max-w-5xl">
              ...
              <div className="mb-6 grid grid-cols-2 gap-3 lg:grid-cols-4">
                {[
                  { l: "Active", v: "3" },
                  { l: "Total Volume", v: "$4,500" },
                  { l: "Yield Earned", v: "$32.50" },
                  { l: "Completed", v: "1" },
                ].map((s) => (
                  <div key={s.l} className="rounded-xl border border-white/6 bg-[#0a0a0c]/70 p-4 backdrop-blur-md">
              ...
              <div className="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-2">
                <div className="rounded-xl border border-white/6 bg-[#0a0a0c]/70 p-5 backdrop-blur-md">
                  <h3 className="mb-1 text-sm font-semibold uppercase tracking-wider text-white/40">Monthly Agreements</h3>
                  <p className="mb-4 text-xs text-white/25">Agreements created per month</p>
                  <div className="h-52">
              ...
              <div className="rounded-xl border border-white/6 bg-[#0a0a0c]/70 p-5 backdrop-blur-md">
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <button onClick={() => setActiveSection("agreements")} className="text-xs font-semibold text-[#f0b400] hover:underline">View All</button>
                </div>
                <div className="flex flex-col gap-3">
                  {mockAgreements.slice(0, 3).map((agr) => {
                    const st = statusConfig[agr.status] || statusConfig.funded
                    return (
                      <div key={agr.id} className="flex items-center justify-between rounded-lg border border-white/4 bg-white/2 px-4 py-3 transition-all hover:border-white/10">
                        <div>
            ...
            <div className="mx-auto max-w-4xl">
              ...
              <div className="flex flex-col gap-4">
                {mockAgreements.map((agr) => {
                  const st = statusConfig[agr.status] || statusConfig.funded
                  return (
                    <div key={agr.id} className="flex flex-col gap-4 rounded-2xl border border-white/6 bg-[#0a0a0c]/70 p-5 backdrop-blur-md transition-all hover:border-white/15 sm:flex-row sm:items-center sm:justify-between">
                      <div>
            ...
            <div className="mx-auto max-w-4xl">
              ...
              <div className="flex flex-col gap-4">
                {connectedWallets.map((w) => (
                  <div key={w.value} className="rounded-2xl border border-white/6 bg-[#0a0a0c]/70 p-6 backdrop-blur-md transition-all hover:border-white/15">
                ...
                {/* Add wallet */}
                <button className="flex items-center justify-center gap-3 rounded-2xl border border-dashed border-white/10 bg-white/2 p-8 text-white/30 hover:border-[#f0b400]/30 hover:text-[#f0b400] transition-all">
          ...
          {activeSection === "create" && (
            <div className="mx-auto max-w-4xl">
              ...
              {submitted ? (
                <div className="flex flex-col items-center gap-6 rounded-2xl border border-white/6 bg-[#0a0a0c]/70 p-10 text-center backdrop-blur-md">
                  ...
                  <div className="flex flex-col items-center gap-3 rounded-xl border border-white/6 bg-white/2 p-6">
                ...
                <div className="rounded-2xl border border-white/6 bg-[#0a0a0c]/70 p-6 backdrop-blur-md sm:p-8">
                        ...
                        {([
                          ...
                          <button key={opt.id} onClick={() => { setEscrowType(opt.id); if (opt.id === "single") setMilestones([{ description: "Full delivery", amount: "" }]) }}
                            className={cn("flex flex-col gap-3 rounded-xl border p-6 text-left transition-all duration-300",
                              escrowType === opt.id ? "border-[#f0b400]/40 bg-[#f0b400]/5" : "border-white/6 bg-white/2 hover:border-white/15")}>  
                        ...
                        {useCases.map((uc) => (
                          <button key={uc.id} onClick={() => { setUseCase(uc.id); setGuidePrefilled(false) }}
                            className={cn("flex items-center gap-3 rounded-xl border p-4 text-left transition-all",
                              useCase === uc.id ? "border-[#f0b400]/40 bg-[#f0b400]/5" : "border-white/6 bg-white/2 hover:border-white/15")}>  
                        ...
                        <div className="flex flex-col gap-3">
                          ...
                          {milestones.map((m, i) => (
                            <div key={i} draggable onDragStart={() => handleDragStart(i)} onDragEnter={() => handleDragEnter(i)} onDragEnd={handleDragEnd} onDragOver={(e) => e.preventDefault()}
                              className="flex flex-col gap-2 rounded-xl border border-white/6 bg-white/2 p-4 sm:flex-row sm:items-center sm:gap-3 cursor-grab active:cursor-grabbing">
                              ...
                              <input value={m.amount} onChange={(e) => updateMilestone(i, "amount", e.target.value)} placeholder="Amount" type="number" className="w-28 rounded-lg border border-white/6 bg-white/2 px-3 py-2 text-sm text-white placeholder:text-white/15 focus:border-[#f0b400]/40 focus:outline-none" />
                          ...
                          <div className="flex items-center justify-between rounded-xl bg-white/3 px-4 py-3"><span className="text-xs text-white/30">Total</span><span className="text-sm font-bold text-white">{totalAmount.toFixed(2)} USDC</span></div>
                        </div>
                      )}
                    </div>
                  )}
                  ...
                  {/* Navigation */}
                  <div className="mt-8 flex items-center justify-between border-t border-white/4 pt-6">
