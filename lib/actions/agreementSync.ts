...
export async function revalidateAgreement(agreementId: string, token?: string): Promise<AgreementSyncResult> {
  ...
  if (rawError.includes("forbidden") || rawError.includes("permission") || rawError.includes("403")) {
