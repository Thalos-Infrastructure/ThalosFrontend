...
const businessModules: ServiceModule[] = [
  {
    id: "multi-escrow",
    label: "Multi-Party Escrow",
    description: "N-party escrow with custom roles",
    icon: "users",
    color: "#3b82f6",
  ...
  },
  {
    id: "fiat-gateway",
    label: "Fiat Gateway",
    description: "Multi-currency on/off ramp",
    icon: "globe",
    color: "#f0b400",
    category: "infrastructure",
  },
  {
    id: "api-bridge",
    label: "API Bridge",
    description: "REST & webhook integrations",
    icon: "code",
    color: "#8b5cf6",
    category: "infrastructure",
  },
  {
    ...
    description: "Buyer-seller payment orchestration",
    icon: "store",
    color: "#f59e0b",
    category: "commerce",
  },
  {
    id: "travel-accum",
    label: "Travel Accumulator",
    description: "Installment travel package flows",
    icon: "plane",
    color: "#06b6d4",
    category: "commerce",
  },
  {
    ...
    description: "Multi-stage conditional releases",
    icon: "layers",
    color: "#10b981",
    category: "commerce",
  },
  {
    id: "kyc-module",
    label: "KYC / AML",
    description: "Identity verification pipeline",
    icon: "shield",
    color: "#ef4444",
    category: "compliance",
  },
  {
    id: "audit-trail",
    label: "Audit Trail",
    description: "Full transaction logging",
    icon: "scroll",
    color: "#64748b",
    category: "compliance",
  },
  {
    id: "yield-pool",
    label: "Yield Pool",
    description: "Enterprise yield on idle capital",
    icon: "trending",
    color: "#a855f7",
    category: "advanced",
  },
  {
    ...
    description: "Scheduled fund settlements",
    icon: "clock",
    color: "#22c55e",
    category: "advanced",
  },
...
const moduleIcons: Record<string, React.ReactNode> = {
  ...
  scroll: (
    ...
    >
      ...
      <path d="M14 17V5a2 2 0 00-2-2H4a2 2 0 00-2 2v12a4 4 0 004 4" />
      <path d="M14 5h6a2 2 0 012 2v10" />
    </svg>
  ),
  trending: (
    <svg
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mb-6 grid grid-cols-2 gap-3 lg:grid-cols-4">
          {[
            ...
            <div
              key={stat.label}
              className="rounded-xl border border-border/40 bg-card/40 p-4 shadow-[0_4px_16px_rgba(0,0,0,0.15),inset_0_1px_0_rgba(255,255,255,0.04)]"
            >
          ...
          <div className="lg:col-span-4">
            <div className="rounded-2xl border border-border/40 bg-card/40 p-5 backdrop-blur-sm shadow-[0_8px_32px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.04)]">
              ...
              <p className="mb-4 text-xs text-muted-foreground">
                Drag modules to the canvas to architect your platform.
              </p>
                          ...
                          >
                            ...
                            {inPipeline && (
                              <svg
                                ...
                                stroke="currentColor"
                                strokeWidth="2"
                                className="ml-auto shrink-0 text-[#f0b400]"
                              >
                ...
                <div className="flex h-[430px] flex-col items-center justify-center gap-3 text-center">
                  <div className="rounded-2xl border border-dashed border-border/50 p-6">
                    ...
                    <p className="text-xs text-muted-foreground/40 mt-1">
                      Build your platform architecture visually
                    </p>
                  </div>
                </div>
              ) : (
                        ...
                        <div key={mod.id} className="flex items-center gap-2">
                          ...
                          {index < pipeline.length - 1 && (
                            <svg
                              ...
                              stroke="currentColor"
                              strokeWidth="1.5"
                              className="shrink-0 text-[#f0b400]/40"
                            >
