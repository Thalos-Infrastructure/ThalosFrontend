...
const availableModules: ServiceModule[] = [
  {
    id: "fiat-onramp",
    label: "Fiat On-ramp",
    description: "Convert local currency to USDC",
    icon: "arrow-up",
    color: "#f0b400",
    category: "payment",
  },
  {
    id: "escrow-basic",
    label: "Basic Escrow",
    description: "Lock funds until conditions met",
    icon: "lock",
    color: "#3b82f6",
    category: "escrow",
  },
  {
    ...
    description: "Release by deliverable stages",
    icon: "layers",
    color: "#10b981",
    category: "release",
  },
  {
    id: "one-time-release",
    label: "One-time Release",
    description: "Single conditional release",
    icon: "zap",
    color: "#8b5cf6",
    category: "release",
  },
  {
    id: "accumulative",
    label: "Accumulative",
    description: "Collect until target amount",
    icon: "trending",
    color: "#f59e0b",
    category: "payment",
  },
  {
    id: "yield",
    label: "Yield on Idle",
    description: "Earn on escrowed funds",
    icon: "sparkle",
    color: "#06b6d4",
    category: "extras",
  },
  {
    ...
    description: "Conflict mediation flow",
    icon: "shield",
    color: "#ef4444",
    category: "extras",
  },
          ...
          <div className="lg:col-span-4">
            <div className="rounded-2xl border border-border/40 bg-card/40 p-5 backdrop-blur-sm shadow-[0_8px_32px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.04)]">
              ...
              <p className="mb-4 text-xs text-muted-foreground">
                Drag modules to the canvas to build your payment flow.
              </p>
                ...
                <div className="flex h-[400px] flex-col items-center justify-center gap-3 text-center">
                  <div className="rounded-2xl border border-dashed border-border/50 p-6">
                    ...
                    <p className="text-sm text-muted-foreground/60">
                      Drag modules here to assemble
                    </p>
                    <p className="text-xs text-muted-foreground/40 mt-1">
                      Your payment flow from left to right
                    </p>
                  </div>
                </div>
              ) : (
