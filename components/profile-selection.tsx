      ...
      <div className={cn(
        ...
        <div className="mx-auto grid max-w-4xl grid-cols-1 gap-6 md:grid-cols-2">
          {profiles.map((profile, idx) => (
            ...
            >
              <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#e6b800]/10 text-[#e6b800]">
                {profile.icon}
              </div>
              ...
              <ul className="mb-8 flex flex-col gap-2.5">
                {profile.features.map((feature) => (
                  <li key={feature} className="flex items-center gap-2.5 text-sm font-medium text-muted-foreground">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="shrink-0 text-[#e6b800]">
