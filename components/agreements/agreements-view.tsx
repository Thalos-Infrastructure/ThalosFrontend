...
export function AgreementsView({ agreements, onAgreementClick, currentUserWallet, className }: AgreementsViewProps) {
...
function AgreementCard({ agreement, onClick }: { agreement: Agreement; onClick: () => void }) {
