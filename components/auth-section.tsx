...
export function AuthSection() {
  ...
  const dashboardHref = dashboardPathFor(
    null,
    profileType === "personal" ? "personal" : "enterprise",
  )

  return (
    <section id="auth" className="relative py-28" ref={ref}>
      <div className={cn("mx-auto max-w-md px-6 section-reveal", isVisible && "is-visible")}>
        <div className="mb-10 text-center">
          ...
          <p className="font-medium text-muted-foreground text-pretty">{t("auth.chooseProfile")}</p>
        </div>
