...
export function Footer() {
  const { t } = useLanguage()
  return (
    <footer className="border-t border-white/8 bg-[#0a0a0c]">
      <div className="mx-auto max-w-7xl px-6 py-12">
          ...
          <div className="grid grid-cols-3 gap-12">
            <div>
              ...
              <ul className="flex flex-col gap-2.5">
                <li><a href="#how-it-works" className="text-sm font-medium text-white/50 transition-colors hover:text-white">{t("nav.howItWorks")}</a></li>
                <li><a href="#profiles" className="text-sm font-medium text-white/50 transition-colors hover:text-white">{t("nav.solutions")}</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="flex flex-col gap-2.5">
                ...
                <li><Link href="/about" className="text-sm font-medium text-white/50 transition-colors hover:text-white">{t("footer.visionTeam")}</Link></li>
                <li><a href="https://thalos.gitbook.io/thalos-docs" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-white/50 transition-colors hover:text-white">{t("footer.documentation")}</a></li>
              </ul>
            </div>
            <div>
        ...
        {/* Copyright */}
        <p className="mt-10 text-center text-xs text-white/20">&copy; {new Date().getFullYear()} Thalos Infrastructure. {t("footer.rights")}</p>
      </div>
    </footer>
  )
}
