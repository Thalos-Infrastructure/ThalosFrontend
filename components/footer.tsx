    ...
    <footer className="border-t border-border/15 bg-background" ref={ref}>
      <div className={cn("mx-auto max-w-7xl px-6 py-12 section-reveal", isVisible && "is-visible")}>
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
          {/* Left: Logo + description + social icons + partners */}
          <div className="flex max-w-md flex-col gap-5">
            ...
            <div className="flex items-center gap-4">
              <a 
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-muted-foreground transition-all hover:border-[#f0b400]/50 hover:bg-[#f0b400]/10 hover:text-[#f0b400]"
                aria-label="Email"
              >
