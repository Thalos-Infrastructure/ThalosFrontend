...
export function Footer() {
  ...
  return (
    <footer className="border-t border-white/10 bg-[#0a0a0c]" ref={ref}>
      <div className={cn("mx-auto max-w-7xl px-6 py-12 section-reveal", isVisible && "is-visible")}>
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex flex-col items-center gap-3">
            <p className="text-xs font-bold uppercase tracking-widest text-[#f0b400]">Connect</p>
            <div className="flex items-center gap-3">
              <a 
                href="mailto:thalosinfrastructure@gmail.com" 
                className="flex h-11 w-11 items-center justify-center rounded-full border border-white/15 bg-white/5 text-white/60 transition-all hover:border-[#f0b400]/50 hover:bg-[#f0b400]/15 hover:text-[#f0b400]"
                aria-label="Email"
              >
