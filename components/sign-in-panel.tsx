        ...
        <div className="relative flex flex-1 flex-col justify-center overflow-y-auto px-8 py-10 md:px-10">
          ...
          <div className="flex flex-col gap-2.5">
            <Link href={dashboardHref} onClick={onClose}>
              <Button variant="outline" className="h-11 w-full gap-3 rounded-xl border-white/15 bg-white/5 text-sm text-white font-semibold hover:bg-white/10 hover:border-white/25 transition-all">
