    ...
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="relative flex flex-1 flex-col justify-center overflow-y-auto px-8 py-10 md:px-10">
          <button
            onClick={onClose}
            className="absolute top-4 right-4 flex h-8 w-8 items-center justify-center rounded-full text-white/30 hover:bg-white/8 hover:text-white transition-colors"
            aria-label="Close"
          >
            <svg
              width="16"
          ...
          <div className="mb-6">
            <p className="mb-2 text-[10px] font-bold uppercase tracking-widest text-white/40">
              {t("signin.accountType")}
            </p>
            <div className="grid grid-cols-2 gap-2">
              {[
                {
                  id: "personal" as const,
                  label: t("signin.personal"),
                  icon: (
                    <svg
                      width="15"
                      height="15"
                ...
                <button
                  ...
                  className={cn(
                    ...
                    profileType === type.id
                      ? "border-[#f0b400]/30 bg-[#f0b400]/10 text-[#f0b400]"
