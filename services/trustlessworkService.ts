...
const PLATFORM_ADDRESS = process.env.NEXT_PUBLIC_PLATFORM_ADDRESS ?? "GAQGVX77PX3UAQCJKXFAYDRFHRCPLTNGMMNEUCENZ525SBW4EYWGRGNK";
const DISPUTE_RESOLVER = process.env.NEXT_PUBLIC_DISPUTE_RESOLVER ?? "GB6MP3L6UGIDY6O6MXNLSKHLXT2T2TCMPZIZGUTOGYKOLHW7EORWMFCK";
export const TRUSTLINE_USDC = { symbol: "USDC", address: "GBBD47IF6LWK7P7MDEVSCWR7DPUWV3NY3DTQEVFL4NAT4AQH3ZLLFLA5" }
...
const DEFAULT_SIGNER = process.env.NEXT_PUBLIC_DEFAULT_SIGNER ?? "GAQGVX77PX3UAQCJKXFAYDRFHRCPLTNGMMNEUCENZ525SBW4EYWGRGNK";
